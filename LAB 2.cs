...
namespace Assignment2
{
    internal class Program
    {
        ...
        {
            Employee e1 = new Employee(1, "Sufiyan", 123.56);
            e1.displayData();
        }
    }
    class Employee
...
namespace Assignment2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Bank b1 = new Bank(12345, "Sufiyan", 1000);
            b1.displayData();
        }
    }
    class Bank
...
namespace Assignment2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Logger.setNameAndPassword("Sufiyan", 1234);
            Logger.Login("Sufiyan", 1234);
...
namespace Assignment2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Employee e1 = new Employee(1, "Sufiyan", 1000);
            e1.displayData();
        }
